...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      'background:#262729;color:#FAF7F0;',
      ...
      '.cc-text{flex:1 1 320px;font-size:13.5px;line-height:1.55;color:#FAF7F0;opacity:.92;margin:0;}',
      '.cc-text a{color:#C9B98C;text-decoration:underline;text-underline-offset:2px;}',
      '.cc-text a:hover{color:#FAF7F0;}',
      ...
      '.cc-btn-accept{background:#0A7390;color:#FAF7F0;}',
      '.cc-btn-accept:hover{background:#085F77;}',
      '.cc-btn-reject{background:transparent;color:#FAF7F0;border:1px solid rgba(250,247,240,.35);}',
      '.cc-btn-reject:hover{border-color:#FAF7F0;}',
      '.cc-btn-customize{background:transparent;color:#C9B98C;border:1px solid rgba(201,185,140,.4);}',
      '.cc-btn-customize:hover{border-color:#C9B98C;color:#FAF7F0;}',
      '.cc-btn-save{background:#0A7390;color:#FAF7F0;}',
      '.cc-btn-save:hover{background:#085F77;}',
      ...
      '.cc-checkbox-row{display:flex;align-items:center;gap:8px;font-size:13px;color:#FAF7F0;}',
      '.cc-checkbox-row input{width:18px;height:18px;accent-color:#0A7390;cursor:pointer;}',
